# VEFMAP: Vegetation responses to e-flows

Data analysis is focused initially around one paper that will feed into VEFMAP Stage 6 reporting. There are various other data analyses being conducted for VEFMAP Veg Stage 6 for other papers that are being done separately to this GitHub project. These additional papers and analyses will also contribute to VEFMAP Stage 6 reporting.
